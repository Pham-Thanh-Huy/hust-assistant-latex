...
% Style bảng glossary tự xuống dòng
\newglossarystyle{huststyle}
{
...
\subfile{Chuong/3_Thiet_ke_he_thong.tex}
...
\label{chapter:hihi}
\subfile{Chuong/4_Xay_dung_va_trien_khai_he_thong.tex}
...
\newpage
%\pagestyle{fancy} % Áp dụng header và footer
\chapter{ĐÁNH GIÁ VÀ THỬ NGHIỆM HỂ THỐNG}
\label{chapter:thu-nghiem}
\subfile{Chuong/5_Danh_gia_va_thu_nghiem.tex}
...
\titlecontents{chapter}
    ...
    {}         % unnumbered format
    {\titlerule*[0.3pc]{.}\contentspage}         % filler-page-format, e.g dots
\chapter{DANH SÁCH API TIÊU BIỂU CỦA HỆ THỐNG}
\subfile{Chuong/Phu_luc_A}

\newpage
\chapter{PROMPT SỬ DỤNG TRONG HỆ THỐNG}
\subfile{Chuong/Phu_luc_B}

\newpage
\chapter{CẤU HÌNH TRIỂN KHAI DOCKER-COMPOSE}
